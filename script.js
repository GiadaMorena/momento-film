document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadState() {
        ...
        if (savedState) {
            ...
            // Script di migrazione per convertire vecchi dati se necessario
    ...
    function renderMovies() {
        ...
        for (const category in groupedMovies) {
            ...
            groupedMovies[category].forEach(movie => {
                ...
                // Le animazioni di ingresso sono state rimosse per garantire la visibilità
    ...
    function updateStatsDashboard(isInitialLoad = false) {
        ...
        if (isInitialLoad || !document.hidden) { // L'animazione parte solo se la scheda è visibile
        ...
        } else { // Caricamento istantaneo se la scheda è in background
